...
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+ASBMRfT6V60zYzI1')

# Pics 

QR_CODE = environ.get('QR_CODE', 'https://files.catbox.moe/o9dc69.jpg')
START_IMG = environ.get('START_IMG', 'https://files.catbox.moe/qjzvgz.jpg')
FSUB_PICS = (environ.get('FSUB_PICS', 'https://files.catbox.moe/9u01o5.jpg https://files.catbox.moe/433i75.jpg')).split() 
...
FILES_DATABASE_URL = environ.get('FILES_DATABASE_URL', "mongodb+srv://nothingsunfav1322_db_user:uhV4xnCmjABxgvYz@cluster0.66dg6cw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # For Files
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002853893090'))
